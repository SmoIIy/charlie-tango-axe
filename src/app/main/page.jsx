    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="mb-8 space-y-3">
                ...
                <h2 className="text-c-grey60">Enter your website, and we will test the accesibility <br />No fuss, no ballade - <span className="text-brand-orange70 underline">read more!</span></h2>
            </div>
            ...
            <form className="w-full" action={submit}>
                ...
                <div className="space-y-1">
                    ...
                    <input className="border-input text-c-grey80 bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-10 w-full rounded-md border px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 shadow-xl" type="url" id="url" placeholder="website.com..." name="url" />
                    </div>
                </div>
            ...
            <div className="text-center"> No placeholder? <a className="text-brand-turquoise50" href="/signup">Create placeholder</a> </div>
            </div>
        </div>
        </section>
  );
